...
@NamedQueries({
    @NamedQuery(name = "Excursao.findAll", query = "SELECT e FROM Excursao e"),
      @NamedQuery(name = "Excursao.findByExcursaoIdUti", query = "SELECT e FROM Excursao e WHERE e.utilizadorId = :utilizadorId")
...
public class Excursao implements Serializable {
    ...
    public String toString() {
        return "projeto2trilho.DAL.Excursao[ excursaoId=" + excursaoId + " ]";
    }
